...
//@WebServlet(name = "RedirectAddItemServlet", urlPatterns = {"/pages/sellZone/seller/addItem"})
public class RedirectAddItemServlet extends HttpServlet {
    ...
    private void processRequest(HttpServletRequest request, HttpServletResponse response) throws IOException {
         ...
         */
        response.sendRedirect(request.getContextPath() + "/pages/sellZone/seller/addItem/add-item.html");
    }
