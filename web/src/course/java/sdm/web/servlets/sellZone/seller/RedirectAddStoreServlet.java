...
//@WebServlet(name = "RedirectAddStoreServlet", urlPatterns = {"/pages/sellZone/seller/addStore"})
public class RedirectAddStoreServlet extends HttpServlet {
    ...
    private void processRequest(HttpServletRequest request, HttpServletResponse response) throws IOException {
         ...
         */
        response.sendRedirect(request.getContextPath() + "/pages/sellZone/seller/addStore/add-store.html");
    }
