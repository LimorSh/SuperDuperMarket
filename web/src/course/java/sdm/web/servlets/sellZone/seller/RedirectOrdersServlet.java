...
//@WebServlet(name = "RedirectOrdersServlet", urlPatterns = {"/pages/sellZone/seller/orders"})
public class RedirectOrdersServlet extends HttpServlet {
    ...
    private void processRequest(HttpServletRequest request, HttpServletResponse response) throws IOException {
         ...
         */
        response.sendRedirect(request.getContextPath() + "/pages/sellZone/seller/orders/orders.html");
    }
