...
function calculateContextPath() {
    let pathWithoutLeadingSlash = window.location.pathname.substring(1);
    let contextPathEndIndex = pathWithoutLeadingSlash.indexOf('/');
...
function wrapBuildingURLWithContextPath() {
    let contextPath = calculateContextPath();
...
let buildUrlWithContextPath = wrapBuildingURLWithContextPath();